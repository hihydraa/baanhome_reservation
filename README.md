...
การชำระเงิน (Module 4) ฝังอยู่ในฟอร์มจองห้องพัก/ห้องจัดเลี้ยงโดยตรง (`components/payment/PaymentPanel.tsx`) — การจองห้องจัดเลี้ยงบังคับให้มีมัดจำหรือชำระเต็มจำนวนก่อนยืนยันเสมอ
