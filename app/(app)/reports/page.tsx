...
import { getOccupancySummary, getMonthlySummary, currentMonthString } from "@/lib/reports";
...
export default async function ReportsPage({
  ...
  const [occupancy, summary] = await Promise.all([getOccupancySummary(month), getMonthlySummary(month)]);
